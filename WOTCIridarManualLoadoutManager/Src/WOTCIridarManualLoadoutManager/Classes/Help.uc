...
WOTCIridarManualLoadoutManager.int
[Help]
...
*/
static final function string GetLocalizedString(const name StringName)
{
	return Localize("Help", string(StringName), "WOTCIridarManualLoadoutManager");
}
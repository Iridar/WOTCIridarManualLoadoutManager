...
static exec function SetPos(int NewPosX, int NewPosY)
{
	class'UIScreen_Loadouts'.default.LeftPanelX = NewPosX;
	class'UIScreen_Loadouts'.default.LeftPanelY = NewPosY;
}

static exec function SetHeight(int NewHeight)
{
	class'UIScreen_Loadouts'.default.LeftPanelH = NewHeight;
}

static exec function SetWidth(int NewWidth)
{

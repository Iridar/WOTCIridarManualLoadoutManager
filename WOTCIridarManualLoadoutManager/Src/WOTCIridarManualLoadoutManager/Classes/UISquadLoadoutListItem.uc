class UISquadLoadoutListItem extends UIButton;

// It extends UIButton, but has UIMechaListItem code!
// What is it, doctor?
// Science has no answers, only more questions.

// This exists because UISquadSelect seems to hijack mouse input from anything that isn't a UIButton, 
// and I need mouse input for tooltips to work.
// When I realized this, my first move was to make an array of buttons, and it worked,
// but I couldn't get rid of button visuals nor align the text to the left.
// So I just copied code from a UI element I'm already familiar with.
...
delegate OnSelectorClickDelegate(UISquadLoadoutListItem MechaItem);
...
simulated function UISquadLoadoutListItem InitListItem(optional name InitName, optional int defaultWidth = -1, optional int textWidth = 250)
{
	local UIList List; 	
...
simulated function UISquadLoadoutListItem UpdateDataDescription(string _Desc,
										  optional delegate<OnClickDelegate> _OnClickDelegate = none)
{
...
simulated function UISquadLoadoutListItem UpdateDataButton(string _Desc,
								 	 string _ButtonLabel,
...
simulated function UISquadLoadoutListItem UpdateDataSpinner(string _Desc,
...
simulated function UISquadLoadoutListItem UpdateDataSpinnerAndButton(string _Desc,
									 string _SpinnerLabel,
									 string _ButtonLabel,
...
simulated function UISquadLoadoutListItem UpdateDataDropdown(string _Desc, 
									   array<String> Data, 
									   int SelectedIndex,
...
simulated function UISquadLoadoutListItem UpdateDataCheckbox(string _Desc,
